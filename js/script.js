...
$('.search-box').on("keyup input", function(){
    ...
    if(inputVal.length){
        $.get("search.php", {term: inputVal}).done(function(data){
            ...
            resultDropdown.css("display","inline-block");
            resultDropdown.css("visibility","visible");
            resultDropdown.css("position","absolute");
            resultDropdown.css("z-index","1000");
            resultDropdown.html(data);
            console.log(resultDropdown.val());
            //$(resultDropdown).modal('show');
        });
    } else{
        resultDropdown.empty();
        resultDropdown.css("display","none");
        resultDropdown.css("visibility","hidden");
    }
