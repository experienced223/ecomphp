									...
									<div class="product">
										<div class="product-thumb">
											...
											<div class="product-overlay">
												<span>
												<a href="single.php?id=<?php echo $r['id']; ?>" class="fa fa-link">See Product</a>
												<a href="addtocart.php?id=<?php echo $r['id']; ?>" class="fa fa-shopping-cart">Add To Cart</a>
												</span>					
											</div>
										</div>
										<h2 class="product-title"><a href="single.php?id=<?php echo $r['id']; ?>"><?php echo $r['name']; ?></a></h2>
										<div class="product-price">AUD <?php echo $r['price']; ?>.00<span></span></div>
									</div>
								</div>
							<?php } ?>
