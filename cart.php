				...
				if(isset($cart)){
                    foreach ($cart as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="amount">AUD <?php echo $cartr['price']; ?>.00</span>
                            </td>
                            <td>
                                <div class="quantity"><?php echo $value['quantity']; ?></div>
                            </td>
                            <td>
                                <span class="amount">AUD <?php echo ($cartr['price']*$value['quantity']); ?>.00</span>
                            </td>
                        </tr>
                        <?php
				...
				<div class="col-md-6 push-md-6 no-padding">
					...
					<table class="table table-bordered col-md-6">
						<tbody>
							<tr>
								<th>Cart Subtotal</th>
								<td><span class="amount">AUD <?php echo $total; ?>.00</span></td>
							</tr>
							<tr>
							...
							<tr>
								<th>Order Total</th>
								<td><strong><span class="amount">AUD <?php echo $total; ?>.00</span></strong> </td>
							</tr>
						</tbody>
					</table>
				</div>
