			...
			<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
					<div class="row">
						...
						<div class="col-md-7 product-single">
							...
							<div class="p-price">AUD <?php echo $prodr['price']; ?>.00</div>
									...
									<div class="product">
										<div class="product-thumb">
											...
											<div class="product-overlay">
												<span>
												<a href="single.php?id=<?php echo $relr['id']; ?>" class="fa fa-link">See Product</a>
												<a href="#" class="fa fa-shopping-cart">Add to Cart</a>
												</span>					
											</div>
										</div>
										<h2 class="product-title"><a href="#"><?php echo $relr['name']; ?></a></h2>
										<div class="product-price">AUD <?php echo $relr['price']; ?>.00<span></span></div>
									</div>
								</div>
							<?php } ?>
							</div>
